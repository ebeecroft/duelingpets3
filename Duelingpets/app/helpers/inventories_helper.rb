                  ...
                  if(userMatch)
                     ...
                     if(itemFound)
                        ...
                        if(amountLeft < 0)
                           ...
                           #Check to see if this item is already in an existing inventory
                           #if so increase that inventory by 1
                           existingInventories = userFound.inventories.select{|inventory| inventory.item_id == item_id}
