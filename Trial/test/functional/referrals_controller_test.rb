...
class ReferralsControllerTest < ActionController::TestCase
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post :create, referral: { created_on: @referral.created_on, referred_by_id: @referral.referred_by_id, user_id: @referral.user_id }
    end
  ...
  test "should update referral" do
    put :update, id: @referral, referral: { created_on: @referral.created_on, referred_by_id: @referral.referred_by_id, user_id: @referral.user_id }
    assert_redirected_to referral_path(assigns(:referral))
  end
